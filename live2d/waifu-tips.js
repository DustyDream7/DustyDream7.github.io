...
live2d_settings['modelTexturesId']      = 66;           // 默认材质 ID，可在 F12 控制台找到
...
live2d_settings['homePageUrl']          = 'https://blog.wkt.xyz';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://blog.wkt.xyz/about/';   // 关于页地址, '{URL 网址}'
