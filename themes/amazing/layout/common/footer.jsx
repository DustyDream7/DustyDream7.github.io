...
class Footer extends Component {
    render() {
        ...
        return <footer class="footer">
            <div class="container">
                <div class="level">
                    <div class="level-start" style="text-align:center;margin:0 auto;">
                        <a class="footer-logo is-block mb-2" href={siteUrl}>
                            {footerLogo}
                        </a>
                        <div>{registeredNo ? <span><a href="http://www.beian.miit.gov.cn/"  style="color:#f72b07" target="_blank">
                            <img src="http://cdn.wkt.xyz/o_1dfilp8ruo521thr1hvf18ji17soa.png"></img>{registeredNo}</a><br />
                        </span> : null}</div>
                        <p class="size-small">
                            ...
                            {websiteStartTime ? <span class="size-small">
